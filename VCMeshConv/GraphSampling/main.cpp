...
void set_7k_mesh_layers(MeshCNN &meshCNN)
{
    ...
    meshCNN.add_pool_layer(4,2,2);//5
    //meshCNN.add_pool_layer(1,1,1);//6
    meshCNN.add_pool_layer(3,2,2);//7
...
{
    meshCNN.add_pool_layer(1,1,1);//0
    meshCNN.add_pool_layer(3,2,2);//1
    meshCNN.add_pool_layer(3,2,2);//2
    meshCNN.add_pool_layer(2,2,2);//3
    meshCNN.add_pool_layer(2,1,1);//4
    meshCNN.add_pool_layer(2,2,2);//5    
    //meshCNN.add_pool_layer(2,2,2);//9
}
...
int main() {
    ...
    std::string meshname = "/home/djq19/workfiles/VirtualBones/VCMeshConv/GraphSampling/template03.obj";
    std::string basepath = "/home/djq19/workfiles/VirtualBones/VCMeshConv/";
    ...
    //set_150k_mesh_layers_option5(meshCNN);
    set_7k_mesh_layers(meshCNN);

    
    string folder= basepath + "/connectmat03";
    mkdir(folder.c_str(), 0755);
       
    std::string outfolderpath = folder+"/cloth03/";
